        ...
        <div className="flex justify-between h-16 items-center gap-4">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            >
              ...
              {totalItems > 0 && (
                <span className="absolute -top-0.5 -right-0.5 inline-flex items-center justify-center w-5 h-5 text-[11px] font-black text-zinc-900 bg-primary rounded-full shadow-[0_0_8px_rgba(245,158,11,0.5)]">
                  {totalItems}
                </span>
              )}
            </Link>
