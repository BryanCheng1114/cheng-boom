    ...
    return (
      <AdminLayout title="Customer Details">
        <div className="flex flex-col items-center justify-center h-[60vh]">
          ...
          <p className="text-zinc-500 font-black uppercase tracking-widest text-xs">{t('retrieving_profile')}</p>
        </div>
      </AdminLayout>
    );
  }
    ...
    return (
      <AdminLayout title="Not Found">
        <div className="text-center py-20">
          <h2 className="text-2xl font-bold text-zinc-500">{t('customer_not_found')}</h2>
          <button 
          ...
          >
            <ChevronLeft size={20} /> {t('back_to_customers')}
          </button>
        </div>
      </AdminLayout>
    );
          ...
          <div className="space-y-6">
            <div className="bg-white  border border-zinc-200  rounded-[40px] p-8 shadow-xl">
              <div className="flex flex-col items-center text-center mb-8">
                ...
                <div className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest ${
                  ...
                  {t(customer.role.toLowerCase()) || customer.role}
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-zinc-500/5 border border-zinc-500/10 rounded-[32px] p-6">
                <p className="text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-1">{t('total_orders')}</p>
                <h4 className="text-3xl font-black italic text-yellow-500">{customer.orders?.length || 0}</h4>
              </div>
              <div className="bg-zinc-500/5 border border-zinc-500/10 rounded-[32px] p-6">
                <p className="text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-1">{t('total_spent')}</p>
            ...
            <div className="space-y-4">
              {!customer.orders || customer.orders.length === 0 ? (
                <div className="bg-zinc-500/5 border border-dashed border-zinc-500/20 rounded-[40px] p-20 text-center">
                  ...
                  <p className="text-zinc-500 font-bold uppercase tracking-widest text-xs">{t('no_orders_yet')}</p>
                </div>
              ) : (
                    ...
                    <div className="p-4 flex flex-wrap items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-6">
                        ...
                        <div className="flex flex-col text-right min-w-[70px]">
                          <span className="text-[9px] font-black text-zinc-500 uppercase tracking-widest">{t('total')}</span>
